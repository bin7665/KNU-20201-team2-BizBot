...
d3.csv(
  "https://raw.githubusercontent.com/bin7665/KNU-20201-team2-BizBot/master/static/data/depart_data_1.csv",
  function (d) {
  ...
  function (data) {
    ...
    s2g2Svg
      ...
      .attr("y", function (d, i) {
        return s2g2Height - 120 + Math.floor(i / 3) * 30;
      })
      .text(function (d, i) {
