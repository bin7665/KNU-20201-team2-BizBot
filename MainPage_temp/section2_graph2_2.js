...
d3.csv(
  "https://raw.githubusercontent.com/bin7665/KNU-20201-team2-BizBot/master/static/data/depart_data_2.csv",
  function (d) {
  ...
  function (data) {
    ...
    s2g2_2Svg
      ...
      .attr("y", function (d, i) {
        return s2g2_2Height - 120 + Math.floor(i / 3) * 30;
      })
      .text(function (d, i) {
        return `${i + 1}. ${d.label}(${d.value})`;
      })
      .style("font-size", 15)
