...
!(function (a, b) {
  ...
  var a = "d3pie",
    ...
    f = {
      initialCheck: function (a) {
        ...
        if (!/[a-zA-Z][a-zA-Z0-9_-]*$/.test(b))
          return (
            console.error("d3pie error: invalid options.misc.cssPrefix"), !1
          );
        ...
        for (var e = [], f = 0; f < d.data.content.length; f++)
          "number" != typeof d.data.content[f].value ||
          isNaN(d.data.content[f].value)
            ? console.log("not valid: ", d.data.content[f])
            : d.data.content[f].value <= 0
            ? console.log(
                "not valid - should have positive value: ",
                d.data.content[f]
              )
            : e.push(d.data.content[f]);
    ...
    g = {
      ...
      processObj: function (a, b, c) {
        return "string" == typeof b
          ? g.processObj(a, b.split("."), c)
          : 1 === b.length && void 0 !== c
          ? ((a[b[0]] = c), a[b[0]])
          : 0 === b.length
          ? a
          : g.processObj(a[b[0]], b.slice(1), c);
      },
    ...
    h = function () {
      ...
      for (
        "boolean" == typeof g && ((k = g), (g = arguments[1] || {}), (i = 2)),
    ...
    i = {
      ...
      computePieRadius: function (a) {
        ...
        "pie-center" !== a.options.header.location &&
          (e -= a.textComponents.headerHeight),
    ...
    j = {
      ...
      positionLabelElements: function (a, b, c) {
        ...
        d.each(function (c, d) {
          var e = d3
              .select(this)
              .selectAll("." + a.cssPrefix + "segmentMainLabel-" + b),
            f = d3
              .select(this)
        ...
        switch (c) {
          case "label-value1":
            d3.selectAll("." + a.cssPrefix + "segmentValue-" + b).attr(
              "dx",
              function (a, b) {
          ...
          case "label-percentage1":
            d3.selectAll("." + a.cssPrefix + "segmentPercentage-" + b).attr(
              "dx",
              function (a, b) {
                return f[b].mainLabel.width + e;
              }
          ...
          case "label-percentage2":
            d3.selectAll("." + a.cssPrefix + "segmentPercentage-" + b)
        ...
        switch ((2 === m && 180 === g && (m = 1), m)) {
          case 0:
            (c =
              ...
              l -
              (a.outerLabelGroupData[b].x - l - h.x) / 2),
              (d =
                a.outerLabelGroupData[b].y +
                (h.y - a.outerLabelGroupData[b].y) / n),
          ...
          d3
            ...
            .attr("transform", function (c, d) {
              ...
              if ("outer" === b)
                ...
                var n = g.getDimensions(
                    a.cssPrefix + "labelGroup" + d + "-inner"
                  ),
                  o = n.w / 2,
                  p = n.h / 4;
      ...
      fadeInLabelsAndLines: function (a) {
        var b =
          "default" === a.options.effects.load.effect
            ? a.options.effects.load.speed
            : 1;
        setTimeout(function () {
          ...
          d3
            ...
            d3
              ...
              .duration(b)
              .style("opacity", 1),
            g.isFunction(a.options.callbacks.onload) &&
              setTimeout(function () {
                try {
      ...
      getIdealOuterLabelPositions: function (a, b) {
        var c = d3
          .select("#" + a.cssPrefix + "labelGroup" + b + "-outer")
          .node();
        if (c) {
          var d = c.getBBox(),
            ...
            g =
              a.pieCenter.y -
              (a.outerRadius + a.options.labels.outer.pieDistance),
            h = i.rotate(f, g, a.pieCenter.x, a.pieCenter.y, e),
            j = "right";
          e > 180 ? ((h.x -= d.width + 8), (j = "left")) : (h.x += 8),
    ...
    k = {
        ...
        b.on("click", function () {
          ...
          k.onSegmentEvent(a, a.options.callbacks.onClickSegment, b, e),
            "none" !== a.options.effects.pullOutSegmentOnClick.effect &&
              (e ? k.closeSegment(a, b.node()) : k.openSegment(a, b.node()));
        }),
          b.on("mouseover", function () {
            ...
            a.options.tooltips.enabled &&
              ((c = b.attr("data-index")), m.showTooltip(a, c));
          ...
          b.on("mouseout", function () {
            ...
            a.options.tooltips.enabled &&
              ((c = b.attr("data-index")), m.hideTooltip(a, c));
            var f = b.attr("class") === a.cssPrefix + "expanded";
      ...
      openSegment: function (a, b) {
        a.isOpeningSegment ||
          ...
          d3
            .select(b)
            .transition()
            .ease(k.effectMap[a.options.effects.pullOutSegmentOnClick.effect])
      ...
      maybeCloseOpenSegment: function () {
        d3.selectAll("." + pie.cssPrefix + "expanded").size() > 0 &&
          k.closeSegment(
            pie,
            d3.select("." + pie.cssPrefix + "expanded").node()
          );
      },
    ...
    l = {
      ...
      addTitle: function (a) {
        a.svg
          ...
          .attr("x", l.offscreenCoord)
          .attr("y", l.offscreenCoord)
      ...
      addSubtitle: function (a) {
        ...
        a.svg
          ...
          .attr("text-anchor", function () {
            var a;
            return (a =
              "top-center" === b || "pie-center" === b ? "middle" : "left");
          })
          .attr("fill", function (a) {
            return a.color;
          })
      ...
      positionSubtitle: function (a) {
        ...
        (b =
          "top-left" === a.options.header.location
            ? c.left
            : (d - c.right) / 2 + c.left),
          (b += a.options.misc.pieCenterOffset.x);
      ...
      getHeaderHeight: function (a) {
        ...
        if (a.textComponents.title.exists) {
          ...
          var d =
            a.options.misc.canvasPadding.bottom + a.textComponents.footer.h;
          b =
    ...
    m = {
      ...
      moveTooltip: function (a) {
        d3.selectAll("#" + a.cssPrefix + "tooltip" + m.currentTooltip).attr(
          "transform",
          function (b) {
      ...
      hideTooltip: function (a, b) {
        d3
          ...
          d3
            .select("#" + a.cssPrefix + "tooltip" + m.currentTooltip)
            .attr("transform", function (b, c) {
      ...
      replacePlaceholders: function (a, b, c, d) {
        g.isFunction(a.options.tooltips.placeholderParser) &&
    ...
    n = function (d, g) {
      ...
      h(!0, j, e, g),
        ...
        f.initialCheck(this) &&
          (d3.select(this.element).attr(a, b), o.call(this), p.call(this));
    };
    ...
    (n.prototype.openSegment = function (a) {
      (a = parseInt(a, 10)),
        0 > a ||
          ...
          k.openSegment(
            this,
            d3.select("#" + this.cssPrefix + "segment" + a).node()
          );
    }),
  ...
  var o = function () {
      (this.options.data.content = i.sortPieData(this)),
        this.options.data.smallSegmentGrouping.enabled &&
          (this.options.data.content = g.applySmallSegmentGrouping(
      ...
      for (
        ...
        this.options.data.content[b].percentage = q(
    ...
    p = function () {
      ...
      this.textComponents.title.exists && b.push(this.cssPrefix + "title"),
        this.textComponents.subtitle.exists &&
          b.push(this.cssPrefix + "subtitle"),
